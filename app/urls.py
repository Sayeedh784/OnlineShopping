...
from app.forms import CustomerRegistrationFrom, LoginForm,MyPasswordChangeForm,MyPasswordResetForm,MySetPasswordForm
from django.urls import path
from django.views.generic.base import View
from app import views
from django.conf import settings
from django.conf.urls.static import static
from .forms import LoginForm, MySetPasswordForm  
...
urlpatterns = [
    ...
    path('registation/', views.CustomerRegistrationView.as_view(),
